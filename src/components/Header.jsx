  ...
  return (
    <header
      className={[
        ...
        scrolled
          ? "bg-[var(--background)]/95 shadow-md"
    ...
    >
      ...
      <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8 h-16 min-[1600px]:h-18 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <Link
            href="/"
            className="text-sm lg:text-base min-[1600px]:text-lg hover:text-gray-900 dark:hover:text-gray-200"
          >
            Home
          </Link>
          <Link
        ...
        <nav className="px-4 pb-4">
          <div className="flex flex-col items-center gap-3">
            <Link
              ...
              className="rounded-xl px-3 py-2 hover:bg-black/5 dark:hover:bg-white/5 w-fit"
            >
              Home
            </Link>
            <Link
